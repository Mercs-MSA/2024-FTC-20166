...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = 931.5043558149142; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -1442.4605441762187; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2090.1820984270457; // x position of the perpendicular encoder (in tick units)
    }
