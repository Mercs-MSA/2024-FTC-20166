...
{
    public static final double ELEVATOR_MULTIPLIER = -1.0;//Bot A = 1.0, Bot B = -1.2?
    ...
    public static final int ELEVATOR_TOP_BASKET = -2200;//Top basket location
    public static final int ELEVATOR_LOW_BASKET = -2100;//Top basket location
    ...
    public static final int ELEVATOR_SPECIMEN_PICKUP = -860;
    public static final double GRABBER_OPEN_POSITION = 0.7;
    public static final double GRABBER_CLOSE_POSITION = 0.95;
    public static final double INTAKE_ARM_UP_POSITION = 0.3;
    public static final double INTAKE_ARM_DOWN_POSITION = 0.7;
